...
CREATE TABLE `Ask` (
  ...
  PRIMARY KEY (`AskID`),
  KEY `Subject` (`Subject`),
  CONSTRAINT `ask_ibfk_1` FOREIGN KEY (`Subject`) REFERENCES `AskSubject` (`SubjectID`)
...
INSERT INTO `Ask` VALUES (1,3,'mtsealove0927@gmail.com','3',0),(2,3,'mtsealove0927@gmail.com','테스트 메세지',0);
